...
#[tracing::instrument(level = "debug", skip(buf, len))]
...
#[tracing::instrument(level = "debug", skip(src, size, start_index, val))]
...
#[tracing::instrument(level = "debug", skip(src, n, val))]
...
#[tracing::instrument(level = "debug", skip(b, begin, n))]
